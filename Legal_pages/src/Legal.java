	...
	private void initialize() {
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			...
			CCPAESP="<H2> Aviso de privacidad para los residentes de California </ H2>\r\n"
					+ "<H3> Definiciones </ H3>\r\n"
					+ "<H4> sitio web </ h4>\r\n"
					+ "SportexLive o https://sportexlive.com\r\n"
			...
			CCPAFR="<!-- wp:heading {\"level\":3} -->\r\n"
					...
					+ "<th>catégorie &lt;/ th&gt;</th>\r\n"
					+ "<th>Exemples &lt;/ th&gt;</th>\r\n"
					+ "<th>collecté &lt;/ th&gt; &lt;/ tr&gt; &lt;/ THEAD&gt;</th>\r\n"
					+ "<td>a. Identifiants. &lt;/ Td&gt;</td>\r\n"
					+ "<td>Un vrai nom, un alias, une adresse postale, un identifiant personnel unique, un identifiant en ligne, une adresse de protocole Internet, une adresse électronique, un nom de compte, un numéro de sécurité sociale, un numéro de permis de conduire, un numéro de passeport ou d'autres identifiants similaires. &lt;/ td&gt;</td>\r\n"
					+ "<td>oui &lt;/ td&gt; &lt;/ tr&gt;</td>\r\n"
					+ "<td>b. Catégories d'informations personnelles répertoriées dans le Statut California Customer Records (CAL. CIV. CODE § 1798.80 (E)). &lt;/ TD&gt;</td>\r\n"
					+ "<td>Nom, signature, numéro de sécurité sociale, caractéristiques physiques ou description, adresse, numéro de téléphone, numéro de passeport, permis de conduire ou numéro de carte d'identification de l'état, numéro de police d'assurance, éducation, emploi, historique de travail, numéro de compte bancaire, carte de crédit nombre, numéro de carte de débit ou toute autre information financière, informations médicales ou informations sur l'assurance maladie. &lt;/ td&gt;</td>\r\n"
					+ "<td>oui &lt;/ td&gt; &lt;/ tr&gt;</td>\r\n"
					+ "<td>c. Caractéristiques de classification protégées en Californie ou loi fédérale. &lt;/ TD&gt;</td>\r\n"
					+ "<td>Âge (40 ans ou plus), race, couleur, ascendance, origine nationale, citoyenneté, religion ou credo, état matrimonial, maladie médicale, invalidité physique ou mentale, sexe (y compris le sexe, l'identité de genre, l'expression de genre, la grossesse ou accouchement et conditions médicales connexes), orientation sexuelle, vétéran ou statut militaire, informations génétiques (y compris les informations génétiques familiales). &lt;/ td&gt;</td>\r\n"
					+ "<td>oui &lt;/ td&gt; &lt;/ tr&gt;</td>\r\n"
					+ "<td>d. Informations commerciales. &lt;/ Td&gt;</td>\r\n"
					+ "<td>enregistrements de biens personnels, de produits ou de services achetés, obtenus ou considérés, ou d'autres histoires d'achat ou de consommation ou de tendances. &lt;/ td&gt;</td>\r\n"
					+ "<td>oui &lt;/ td&gt; &lt;/ tr&gt;</td>\r\n"
					+ "<td>e. Informations biométriques. &lt;/ TD&gt;</td>\r\n"
					+ "<td>Caractéristiques génétiques, physiologiques, comportementales et biologiques, ou des motifs d'activité utilisés pour extraire un modèle ou une autre identifiant ou d'identifier des informations, telles que des empreintes digitales, des empreintes de face et des pompes vocales, des iris ou des analyses de rétine, de la frappe, de la démarche ou d'autres modèles physiques et des données de sommeil, de santé ou d'exercice. &lt;/ td&gt;</td>\r\n"
					+ "<td>oui &lt;/ td&gt; &lt;/ tr&gt;</td>\r\n"
					+ "<td>f. Internet ou autre activité de réseau similaire. &lt;/ Td&gt;</td>\r\n"
					+ "<td>Historique de navigation, historique de recherche, informations sur l'interaction d'un consommateur avec un site Web, une application ou une publicité. &lt;/ td&gt;</td>\r\n"
					+ "<td>oui &lt;/ td&gt; &lt;/ tr&gt;</td>\r\n"
					+ "<td>g. Données de géolocalisation. &lt;/ Td&gt;</td>\r\n"
					+ "<td>Emplacement physique ou mouvements. &lt;/ TD&gt;</td>\r\n"
					+ "<td>oui &lt;/ td&gt; &lt;/ tr&gt;</td>\r\n"
					+ "<td>h. Données sensorielles. &lt;/ Td&gt;</td>\r\n"
					+ "<td>Audio, électronique, visuelle, thermique, olfactive ou des informations similaires. &lt;/ td&gt;</td>\r\n"
					+ "<td>oui &lt;/ td&gt; &lt;/ tr&gt;</td>\r\n"
					+ "<td>i. Informations professionnelles ou liées à l'emploi. &lt;/ Td&gt;</td>\r\n"
					+ "<td>Historique des emplois actuels ou passés ou évaluations de performance. &lt;/ td&gt;</td>\r\n"
					+ "<td>oui &lt;/ td&gt; &lt;/ tr&gt;</td>\r\n"
					+ "<td>j. Information sur l'éducation non publique (par la Loi sur les droits de l'éducation familiale et la loi sur la protection de la vie privée (20 U.S.C. Section 1232G, 34 c.f.r. Partie 99)). &lt;/ TD&gt;</td>\r\n"
					+ "<td>Les dossiers d'éducation directement liés à un étudiant géré par un établissement d'enseignement ou une partie agissant en son nom, tels que des notes, des transcriptions, des listes de classe, des programmes d'élèves, des codes d'identification des étudiants, des informations financières des étudiants ou des archives disciplinaires des étudiants. &lt;/ TD &gt;</td>\r\n"
					+ "<td>oui &lt;/ td&gt; &lt;/ tr&gt;</td>\r\n"
					+ "<td>k. Inferences drawn from other personal information.</td>\r\n"
					+ "<td>Profil reflétant les préférences, caractéristiques, tendances psychologiques, prédispositions, comportement, attitudes, intelligence, capacités et aptitudes. &lt;/ td&gt;</td>\r\n"
					+ "<td>oui &lt;/ td&gt; &lt;/ tr&gt; &lt;/ tbody&gt; &lt;/ table&gt; <!-- /wp:html -->\r\n"
					+ "\r\n"
					+ "<!-- wp:paragraph -->\r\n"
